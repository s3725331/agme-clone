            ...
            <div className="card" data-test="past-bookings-card">
              ...
              <div className="card-content" data-test="account-details">
                  ...
                  >
                    ...
                    {this.state.workers.map((worker, index) => (
                      <option key={worker["id"]} value={index}>
                        {" "}
                        {worker["account"]["firstName"]}{" "}
                        {worker["account"]["lastName"]}
                      </option>
                    ))}
                  </select>
                )}
                ...
                {this.state.account === "Admin" ? (
                  this.state.worker === null ? (
                    ...
                    [
                      <h6>
                        Full name:{" "}
                        {
                          this.state.workers[this.state.worker]["account"][
                            "firstName"
                          ]
                        }{" "}
                        {
                      ...
                      <h6>
                        Service:{" "}
                        {
                          this.state.workers[this.state.worker]["serviceName"][
                            "service"
                          ]
                        }
                      </h6>,
                  ...
                  [
                    <h6>
                      Full name: {this.state.profile["account"]["firstName"]}{" "}
                      {this.state.profile["account"]["lastName"]}
                    </h6>,
                    <h6>Email: {this.state.profile["account"]["email"]}</h6>,
                    this.state.account === "Worker" ? (
                      <h6>
                        Service: {this.state.profile["serviceName"]["service"]}
                      </h6>
                    ) : null,
                  ]
                )}
                    ...
                    this.state.displayedBooking != null ? (
                      this.state.displayedBooking.map((book, index) => (
                        <div key={book["id"]}>
                          ...
                          <h6>
                            Worker: {book["worker"]["account"]["firstName"]}{" "}
                            {book["worker"]["account"]["lastName"]}
                          </h6>
                          <h6>
                            Customer: {book["customer"]["account"]["firstName"]}{" "}
                            {book["customer"]["account"]["lastName"]}
                          </h6>
                          <h6>
                            Service: {book["worker"]["serviceName"]["service"]}
                          </h6>
                      ...
                      this.state.account === "Worker" ? null : (
                        this.state.book.map((book, index) => (
                          <div key={book["id"]}>
                            ...
                            <h6>
                              Service:{" "}
                              {book["worker"]["serviceName"]["service"]}
                            </h6>
                            <h6>
