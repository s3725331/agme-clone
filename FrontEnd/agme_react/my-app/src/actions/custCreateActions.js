...
export const createCustomer = (newAccount, service, type, history) => async dispatch => {
  try {
      ...
      if(type === "Customer"){
        ...
        const  res2 = await axios.post("http://localhost:8080/api/worker/account", newAccount, { params: { service :
        service}});
      }
